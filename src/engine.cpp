...
{
	int x1, y1, x2, y2, bot, topu, nintx, ninty, cnt, z;
	int x21, y21, x43, y43;
		 ...
		 int walldist, int ceildist, int flordist, unsigned int cliptype)
{
	...
	sectortype* sec2;
	walltype* wal;
	int i, j, t, dx, dy, dax, day, daz, daz2;
